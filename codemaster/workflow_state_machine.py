"""
Workflow state machine for managing Codemaster workflow states and transitions.
...
from .exceptions import CodemasterError, ErrorCode
...
class WorkflowStateMachine:
    """
    State machine for managing Codemaster workflow states and transitions.
