"""
Dependency injection container for the Codemaster application.
...
from .command_handler import CodemasterCommandHandler
...
class CodemasterContainer(IServiceContainer):
    """
    Dependency injection container for managing Codemaster services.
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        logger.info("CodemasterContainer initialized")
    
    def _register_lightweight_core_services(self) -> None:
        """Register core Codemaster services with ultra-lightweight lazy initialization."""
        try:
            ...
            self.register(
                ...
                lambda: CodemasterCommandHandler(
    ...
    def _register_command_handlers(self) -> None:
        ...
        try:
            ...
            from .command_handler import (
                CreateSessionHandler, DeclareCapabilitiesHandler, DefineSuccessAndStandardsHandler,
            ...
            # Get dependencies
            main_handler = self.resolve(CodemasterCommandHandler)
            session_manager = self.resolve(SessionManager)
    ...
    def resolve(self, service_type: Type[T]) -> T:
        ...
        """
        # Ensure command handlers are registered when resolving CodemasterCommandHandler
        if service_type.__name__ == 'CodemasterCommandHandler':
    ...
    def dispose(self) -> None:
        ...
        logger.info("CodemasterContainer disposed")


class ServiceScope:
    """Context manager for service scopes."""
    
    def __init__(self, container: CodemasterContainer, scope_id: str):
...
class ContainerBuilder:
    """Builder for creating and configuring CodemasterContainer instances."""
    ...
    def build(self) -> CodemasterContainer:
        """
        Build the container with the configured services.
        
        Returns:
            Configured CodemasterContainer instance
        """
        container = CodemasterContainer(self._config)
...
_global_container: Optional[CodemasterContainer] = None


def get_container() -> CodemasterContainer:
    """
    Get the global container instance.
    
    Returns:
        The global CodemasterContainer instance
    """
    global _global_container
    if _global_container is None:
        _global_container = CodemasterContainer()
    return _global_container


def set_container(container: CodemasterContainer) -> None:
    """
